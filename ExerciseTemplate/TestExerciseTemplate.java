...
public class TestExerciseTemplate {
	...
	public static void main(String[] args) {
        ...
        int a = 5;
        int b = 7;
        testFramework.assertEquals(12, a + b, "addition check");

        String s = "value";
        testFramework.assertEquals("value", s, "string comparison");

        s = "different_value";
        testFramework.assertEquals("value", s, "string comparison 2");
