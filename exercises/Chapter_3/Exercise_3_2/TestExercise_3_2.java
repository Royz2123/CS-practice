...
public class TestExercise_3_2 {
	...
	public static void main(String[] args) {
	    ...
	    int bishopRow = 6;
	    int bishopCol = 5;
	    boolean isThreat = Exercise_3_2.rookIsThreat(rookRow, rookCol, bishopRow, bishopCol);
	    ...
	    int bishopRow2 = 8;
	    int bishopCol2 = 5;
	    boolean isThreat2 = Exercise_3_2.rookIsThreat(rookRow2, rookCol2, bishopRow2, bishopCol2);
	    ...
	    int bishopRow3 = 8;
	    int bishopCol3 = 5;
	    boolean isThreat3 = Exercise_3_2.rookIsThreat(rookRow3, rookCol3, bishopRow3, bishopCol3);
	    ...
	    int bishopRow4 = 5;
	    int bishopCol4 = 5;
	    boolean isThreat4 = Exercise_3_2.bishopIsThreat(rookRow4, rookCol4, bishopRow4, bishopCol4);
	    ...
	    int bishopRow5 = 1;
	    int bishopCol5 = 8;
	    boolean isThreat5 = Exercise_3_2.bishopIsThreat(rookRow5, rookCol5, bishopRow5, bishopCol5);
	    ...
	    int bishopRow6 = 1;
	    int bishopCol6 = 1;
	    boolean isThreat6 = Exercise_3_2.bishopIsThreat(rookRow6, rookCol6, bishopRow6, bishopCol6);
