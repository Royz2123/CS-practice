/**
 * Exercise_3_3_sol - Find if rook and bishop threaten each other
 *
 */
public class Exercise_3_3_sol {
	 ...
	 */
	public static boolean bishopIsThreat(int rookRow, int rookCol, int bishopRow, int bishopCol) {
