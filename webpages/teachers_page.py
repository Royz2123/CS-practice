...
class TeachersPage(BasePage):
    ...
    FILE_EXPLANATIONS = [
        "`Exercise_2_4.java` - **קובץ התבנית לתרגיל** - קובץ זה יהיה הטמפלייט שהחניכים יתחילו ממנו את התרגיל. הקובץ יכיל מחלקה אחת ששמה `Exercise_2_4`, שתכיל את כל החתימות לפונקציות שתרצו לספק לתלמידים.",
